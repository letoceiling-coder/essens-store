...
const routes = [
    ...
    // Store routes
    {
        path: '/catalog',
        name: 'catalog',
        component: () => import('./pages/store/Catalog.vue'),
        meta: { requiresAuth: false },
    },
    {
        path: '/product/:id',
    ...
    },
    {
        path: '/about',
        name: 'about',
        component: () => import('./pages/store/About.vue'),
        meta: { requiresAuth: false },
    },
    {
        path: '/contacts',
    ...
    },
    {
        path: '/shipping',
        name: 'shipping',
        component: () => import('./pages/store/Shipping.vue'),
        meta: { requiresAuth: false },
    },
    {
        path: '/privacy',
        name: 'privacy',
        component: () => import('./pages/store/Privacy.vue'),
        meta: { requiresAuth: false },
    },
    {
        path: '/terms',
        name: 'terms',
        component: () => import('./pages/store/Terms.vue'),
        meta: { requiresAuth: false },
    },
    {
        path: '/faq',
        name: 'faq',
        component: () => import('./pages/store/FAQ.vue'),
        meta: { requiresAuth: false },
    },
    // Admin routes
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import('./pages/admin/ProductCategories.vue'),
            },
            {
                path: 'product-subcategories',
                name: 'admin.product-subcategories',
                component: () => import('./pages/admin/ProductSubcategories.vue'),
            },
            {
                path: 'promotions',
...
router.beforeEach((to, from, next) => {
    ...
    // Store routes don't require auth, allow them
